...
class LogcatMonitor {
  static const MethodChannel _channel = const MethodChannel('logcat_monitor/methods');
  static const EventChannel _stream = const EventChannel('logcat_monitor/events');
